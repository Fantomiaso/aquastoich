...
TDS kann für Ausgangswasser und jedes Aquarium eingegeben, als Ziel mit zulässigem Bereich verwendet und im Messprotokoll in ppm gespeichert werden. Der berechnete Wert addiert zum Anfangsmesswert die Masse **bekannter Ionen** der dosierten Mittel (mg/l, in Süßwasser ungefähr ppm). Beim Wasserwechsel werden zunächst Aquarien- und Ausgangswasser nach Volumen gemischt. Die App rechnet Leitfähigkeit nicht in TDS um; die ppm-Skala des Messgeräts kann von der Massenschätzung abweichen. Unbekannte Inhaltsstoffe, Ausfällungen und Reaktionen können den Messwert ebenfalls verändern. Ohne Anfangsmessung erscheint der Wert als unbekannt und die automatische Anpassung an ein TDS-Ziel wird gesperrt. Mit demselben Messgerät nachprüfen.
