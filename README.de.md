...
2. Nur benötigte Zielwerte ausfüllen. Ein leeres Feld wird ignoriert; null ist ein gültiger Zielwert. Unter jedem Wasserziel kann **Zulässiger Bereich** geöffnet und eine oder beide Grenzen eingetragen werden, auch ohne exaktes Ziel. Eine oder mehrere Vorlagen setzen Wasserziele, deren Bereiche und Ionenverhältnisse. Überlappende Bereiche werden geschnitten; unvereinbare Bereiche werden erklärt. Die Beispiele an Arten und Messwerte anpassen. Bei Bedarf ein Verhältnis wie NO₃:PO₄ = 12:1 mit Grenzen angeben.
