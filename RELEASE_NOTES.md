...
In 1.0a, each light fixture can have up to eight selected or custom channels, each set from 0 to 100%. Channels start empty and are included in the measurement log and Excel export. Effect tags now separate increase/decrease from ionic charge; total analytes are marked with Σ.
...
В 1.0a к светильнику можно добавить до восьми каналов из списка или своих, установив каждому яркость от 0 до 100 %. По умолчанию каналы не заданы. Они сохраняются в журнале и экспорте Excel. Знак повышения или снижения в эффектах отделён от заряда иона; суммарные показатели отмечены Σ.
...
In 1.0a lassen sich bis zu acht vordefinierte oder eigene Lichtkanäle mit jeweils 0–100 % einstellen. Anfangs sind keine Kanäle gewählt; das Messprotokoll und der Excel-Export speichern sie. Wirkungs-Tags trennen Zu- oder Abnahme von der Ionenladung; Summenwerte sind mit Σ markiert.
